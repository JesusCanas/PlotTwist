...
public class PeliculasDAO {
    ...
    public PeliculasDAO() {
        ...
        Pelicula pelicula1 = new Pelicula("Inception", 2010, List.of(Genero.CIENCIA_FICCION, Genero.THRILLER),
        ...
        Pelicula pelicula2 = new Pelicula("Pulp Fiction", 1994, List.of(Genero.DRAMA, Genero.THRILLER), idDirector2,
                8.9, idsActores2, 154);
        ...
        Pelicula pelicula3 = new Pelicula("Jurassic Park", 1993, List.of(Genero.AVENTURA, Genero.CIENCIA_FICCION),
        ...
        Pelicula pelicula4 = new Pelicula("The Wolf of Wall Street", 2013, List.of(Genero.DRAMA, Genero.COMEDIA),
        ...
        Pelicula pelicula5 = new Pelicula("Gladiator", 2000, List.of(Genero.ACCION, Genero.DRAMA), idDirector5, 8.5,
                idsActores5, 155);
        ...
        Pelicula pelicula6 = new Pelicula("Titanic", 1997, List.of(Genero.ROMANCE, Genero.DRAMA), idDirector6, 7.8,
                idsActores6, 195);
        ...
        Pelicula pelicula7 = new Pelicula("Psycho", 1960, List.of(Genero.THRILLER, Genero.HORROR), idDirector7, 8.5,
                idsActores7, 109);
        ...
        Pelicula pelicula10 = new Pelicula("The Godfather", 1972, List.of(Genero.DRAMA, Genero.THRILLER), idDirector10,
