...
public class PeliculasDAO {
    ...
    public PeliculasDAO() {
        ...
        List<String> idsActores1 = List.of("507f1f77bcf86cd799439011", "507f1f77bcf86cd799439012", "507f1f77bcf86cd799439013");
        Pelicula pelicula1 = new Pelicula("Inception", 2010, List.of(Genero.CIENCIA_FICCION, Genero.THRILLER), "", "", idDirector1.toHexString(), 8.8, idsActores1, 148);
        ...
        List<String> idsActores2 = List.of("507f1f77bcf86cd799439014", "507f1f77bcf86cd799439015");
        Pelicula pelicula2 = new Pelicula("Pulp Fiction", 1994, List.of(Genero.DRAMA, Genero.THRILLER), "", "", idDirector2.toHexString(), 8.9, idsActores2, 154);
        ...
        List<String> idsActores3 = List.of("507f1f77bcf86cd799439016", "507f1f77bcf86cd799439017", "507f1f77bcf86cd799439018");
        Pelicula pelicula3 = new Pelicula("Jurassic Park", 1993, List.of(Genero.AVENTURA, Genero.CIENCIA_FICCION), "", "", idDirector3.toHexString(), 8.1, idsActores3, 127);
        ...
        List<String> idsActores4 = List.of("507f1f77bcf86cd799439019", "507f1f77bcf86cd799439020");
        Pelicula pelicula4 = new Pelicula("The Wolf of Wall Street", 2013, List.of(Genero.DRAMA, Genero.COMEDIA), "", "", idDirector4.toHexString(), 8.2, idsActores4, 180);
        ...
        List<String> idsActores5 = List.of("507f1f77bcf86cd799439021", "507f1f77bcf86cd799439022", "507f1f77bcf86cd799439023");
        Pelicula pelicula5 = new Pelicula("Gladiator", 2000, List.of(Genero.ACCION, Genero.DRAMA), "", "", idDirector5.toHexString(), 8.5,
                idsActores5, 155);
        ...
        List<String> idsActores6 = List.of("507f1f77bcf86cd799439024", "507f1f77bcf86cd799439025");
        Pelicula pelicula6 = new Pelicula("Titanic", 1997, List.of(Genero.ROMANCE, Genero.DRAMA), "", "", idDirector6.toHexString(), 7.8,
                idsActores6, 195);
        ...
        List<String> idsActores7 = List.of("507f1f77bcf86cd799439026", "507f1f77bcf86cd799439027");
        Pelicula pelicula7 = new Pelicula("Psycho", 1960, List.of(Genero.THRILLER, Genero.HORROR), "", "", idDirector7.toHexString(), 8.5,
                idsActores7, 109);
        ...
        List<String> idsActores8 = List.of("507f1f77bcf86cd799439028", "507f1f77bcf86cd799439029", "507f1f77bcf86cd799439030");
        Pelicula pelicula8 = new Pelicula("The Nightmare Before Christmas", 1993,
                List.of(Genero.FANTASIA, Genero.COMEDIA), "", "", idDirector8.toHexString(), 8.0, idsActores8, 76);
        ...
        List<String> idsActores9 = List.of("507f1f77bcf86cd799439031", "507f1f77bcf86cd799439032");
        Pelicula pelicula9 = new Pelicula("2001: A Space Odyssey", 1968, List.of(Genero.CIENCIA_FICCION, Genero.AVENTURA),
                        "", "", idDirector9.toHexString(), 8.3, idsActores9, 149);
        ...
        List<String> idsActores10 = List.of("507f1f77bcf86cd799439033", "507f1f77bcf86cd799439034", "507f1f77bcf86cd799439035");
        Pelicula pelicula10 = new Pelicula("The Godfather", 1972, List.of(Genero.DRAMA, Genero.THRILLER), "", "", idDirector10.toHexString(),
